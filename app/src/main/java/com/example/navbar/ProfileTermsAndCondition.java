package com.example.navbar; // Replace with your actual package name
...
public class ProfileTermsAndCondition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText(getString(R.string.termsacondition)); // Set the title text (using string resource)
