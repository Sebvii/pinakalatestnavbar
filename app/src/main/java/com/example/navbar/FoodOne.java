...
public class FoodOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_one);  // Set the layout for the activity
        ...
        captureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent captureIntent = new Intent(FoodOne.this, FoodOne.class);  // Change to the correct activity
